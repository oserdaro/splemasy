function addSystemEditorstoStudents(){
  ...
  while(files.hasNext()){
    ...
    SpreadsheetApp.setActiveSpreadsheet(spreadsheet);
        ...
        sheet.activate();
        sheet.getRange('A1:AZ1').activate();
        //remove range protections
            ...
            return existingProtection.getRange().getA1Notation() == 'A1:AZ1';    });
        ...
        var protection = spreadsheet.getActiveSheet().getRange('A1:AZ1').protect();
        protection.removeEditors(protection.getEditors());
        //add sheet protection except certain cells
        var protection = spreadsheet.getActiveSheet().protect();
        protection.setUnprotectedRanges([spreadsheet.getActiveSheet().getRange('A1:AZ1')]);
        protection.removeEditors(protection.getEditors());
